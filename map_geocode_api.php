...
function get_geocode($address){
    ...
    $url ="https://maps.googleapis.com/maps/api/geocode/json?address={$address}&key=AIzaSyAdqaUX2LYnZ17Sqk18piLoTw6mGN5TzLg";
...
echo json_encode(get_geocode('Universiti Teknologi MARA, Cawangan Perlis, Arau, Perlis'));
?>